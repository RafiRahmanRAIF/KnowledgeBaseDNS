...
명령 프롬프트를 관리자 권한으로 실행합니다. Then, enter the following command: `ipconfig /flushdns`. If the command succeeds, you'll receive the message *Successfully flushed the DNS Resolver Cache*.
